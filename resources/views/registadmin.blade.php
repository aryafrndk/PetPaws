                    ...
                    <div class="col-12 col-md-9 col-lg-7 col-xl-6">
                        <div class="card" style=" margin : 80px ;padding: 1px; ;border-radius: 10px; background: #fff;">
                            ...
                            <div class="form-group">
                                <label for="usernameadmin" class="mt-3 mb-0">Username</label>
                                <input type="text" class="form-control" id="usernameadmin" name ="usernameadmin" placeholder="Enter Username" required>
                                @error('username')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="form-group">
                                <label for="passwordadmin" class="mt-3 mb-0">Password</label>
                                <input type="password" class="form-control" id="passwordadmin" name ="passwordadmin" placeholder="Enter Password" required>
                            </div>
                            <div class="form-group">
